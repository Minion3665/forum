		...
		if (!status) {
			...
			return (
				<React.Fragment>
					<UserInput type="post"
						to={board}
						onsubmit={(title, body) => {postPost("Board:"+board+" "+title, body, this.state.repoid); alert("Posted! (if you don't see your post after pressing ok and waiting for the posts to load, please press f5)")}
					}/>
					{
